...
func (c *pointsClient) CreateVectorName(ctx context.Context, in *CreateVectorNameRequest, opts ...grpc.CallOption) (*PointsOperationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PointsOperationResponse)
	err := c.cc.Invoke(ctx, Points_CreateVectorName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *pointsClient) DeleteVectorName(ctx context.Context, in *DeleteVectorNameRequest, opts ...grpc.CallOption) (*PointsOperationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PointsOperationResponse)
	err := c.cc.Invoke(ctx, Points_DeleteVectorName_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPointsServer) CreateVectorName(context.Context, *CreateVectorNameRequest) (*PointsOperationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateVectorName not implemented")
}
func (UnimplementedPointsServer) DeleteVectorName(context.Context, *DeleteVectorNameRequest) (*PointsOperationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteVectorName not implemented")
}
...
func _Points_CreateVectorName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateVectorNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PointsServer).CreateVectorName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Points_CreateVectorName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PointsServer).CreateVectorName(ctx, req.(*CreateVectorNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Points_DeleteVectorName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteVectorNameRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PointsServer).DeleteVectorName(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Points_DeleteVectorName_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PointsServer).DeleteVectorName(ctx, req.(*DeleteVectorNameRequest))
	}
	return interceptor(ctx, in, info, handler)
}
