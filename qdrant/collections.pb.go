...
const (
	...
	ReplicaState_Resharding          ReplicaState = 7 // Points are being migrated to this shard as part of scale-up resharding
	ReplicaState_ReshardingScaleDown ReplicaState = 8 // Points are being migrated to this shard as part of scale-down resharding
	ReplicaState_ActiveRead          ReplicaState = 9 // Active for readers, Partial for writers
)
...
const (
	ReshardingDirection_Up   ReshardingDirection = 0 // Scale up, add a new shard
	ReshardingDirection_Down ReshardingDirection = 1 // Scale down, remove a shard
)
...
type WalConfigDiff struct {
	...
	WalRetainClosed  *uint64 `protobuf:"varint,3,opt,name=wal_retain_closed,json=walRetainClosed,proto3,oneof" json:"wal_retain_closed,omitempty"`    // Number of closed segments to retain
}
...
type BinaryQuantization struct {
	...
	Encoding  *BinaryQuantizationEncoding `protobuf:"varint,2,opt,name=encoding,proto3,enum=qdrant.BinaryQuantizationEncoding,oneof" json:"encoding,omitempty"` // Binary quantization encoding method
...
type StrictModeConfig struct {
	...
	Enabled                       *bool                        `protobuf:"varint,1,opt,name=enabled,proto3,oneof" json:"enabled,omitempty"`                                                                                         // Whether strict mode is enabled for a collection or not.
	MaxQueryLimit                 *uint32                      `protobuf:"varint,2,opt,name=max_query_limit,json=maxQueryLimit,proto3,oneof" json:"max_query_limit,omitempty"`                                                      // Max allowed `limit` parameter for all APIs that don't have their own max limit.
	MaxTimeout                    *uint32                      `protobuf:"varint,3,opt,name=max_timeout,json=maxTimeout,proto3,oneof" json:"max_timeout,omitempty"`                                                                 // Max allowed `timeout` parameter.
	UnindexedFilteringRetrieve    *bool                        `protobuf:"varint,4,opt,name=unindexed_filtering_retrieve,json=unindexedFilteringRetrieve,proto3,oneof" json:"unindexed_filtering_retrieve,omitempty"`               // Allow usage of unindexed fields in retrieval based (e.g. search) filters.
	UnindexedFilteringUpdate      *bool                        `protobuf:"varint,5,opt,name=unindexed_filtering_update,json=unindexedFilteringUpdate,proto3,oneof" json:"unindexed_filtering_update,omitempty"`                     // Allow usage of unindexed fields in filtered updates (e.g. delete by payload).
	SearchMaxHnswEf               *uint32                      `protobuf:"varint,6,opt,name=search_max_hnsw_ef,json=searchMaxHnswEf,proto3,oneof" json:"search_max_hnsw_ef,omitempty"`                                              // Max HNSW ef value allowed in search parameters.
	SearchAllowExact              *bool                        `protobuf:"varint,7,opt,name=search_allow_exact,json=searchAllowExact,proto3,oneof" json:"search_allow_exact,omitempty"`                                             // Whether exact search is allowed.
	SearchMaxOversampling         *float32                     `protobuf:"fixed32,8,opt,name=search_max_oversampling,json=searchMaxOversampling,proto3,oneof" json:"search_max_oversampling,omitempty"`                             // Max oversampling value allowed in search
	UpsertMaxBatchsize            *uint64                      `protobuf:"varint,9,opt,name=upsert_max_batchsize,json=upsertMaxBatchsize,proto3,oneof" json:"upsert_max_batchsize,omitempty"`                                       // Max batchsize when upserting
	MaxCollectionVectorSizeBytes  *uint64                      `protobuf:"varint,10,opt,name=max_collection_vector_size_bytes,json=maxCollectionVectorSizeBytes,proto3,oneof" json:"max_collection_vector_size_bytes,omitempty"`    // Max size of a collections vector storage in bytes, ignoring replicas.
	ReadRateLimit                 *uint32                      `protobuf:"varint,11,opt,name=read_rate_limit,json=readRateLimit,proto3,oneof" json:"read_rate_limit,omitempty"`                                                     // Max number of read operations per minute per replica
	WriteRateLimit                *uint32                      `protobuf:"varint,12,opt,name=write_rate_limit,json=writeRateLimit,proto3,oneof" json:"write_rate_limit,omitempty"`                                                  // Max number of write operations per minute per replica
	MaxCollectionPayloadSizeBytes *uint64                      `protobuf:"varint,13,opt,name=max_collection_payload_size_bytes,json=maxCollectionPayloadSizeBytes,proto3,oneof" json:"max_collection_payload_size_bytes,omitempty"` // Max size of a collections payload storage in bytes, ignoring replicas.
	FilterMaxConditions           *uint64                      `protobuf:"varint,14,opt,name=filter_max_conditions,json=filterMaxConditions,proto3,oneof" json:"filter_max_conditions,omitempty"`                                   // Max conditions a filter can have.
	ConditionMaxSize              *uint64                      `protobuf:"varint,15,opt,name=condition_max_size,json=conditionMaxSize,proto3,oneof" json:"condition_max_size,omitempty"`                                            // Max size of a condition, eg. items in `MatchAny`.
	MultivectorConfig             *StrictModeMultivectorConfig `protobuf:"bytes,16,opt,name=multivector_config,json=multivectorConfig,proto3,oneof" json:"multivector_config,omitempty"`                                            // Multivector strict mode configuration
	SparseConfig                  *StrictModeSparseConfig      `protobuf:"bytes,17,opt,name=sparse_config,json=sparseConfig,proto3,oneof" json:"sparse_config,omitempty"`                                                           // Sparse vector strict mode configuration
	MaxPointsCount                *uint64                      `protobuf:"varint,18,opt,name=max_points_count,json=maxPointsCount,proto3,oneof" json:"max_points_count,omitempty"`                                                  // Max number of points estimated in a collection
	MaxPayloadIndexCount          *uint64                      `protobuf:"varint,19,opt,name=max_payload_index_count,json=maxPayloadIndexCount,proto3,oneof" json:"max_payload_index_count,omitempty"`                              // Max number of payload indexes in a collection
}
...
type StrictModeSparse struct {
	...
	MaxLength *uint64 `protobuf:"varint,10,opt,name=max_length,json=maxLength,proto3,oneof" json:"max_length,omitempty"` // Max length of sparse vector
}
...
type StrictModeMultivector struct {
	...
	MaxVectors *uint64 `protobuf:"varint,1,opt,name=max_vectors,json=maxVectors,proto3,oneof" json:"max_vectors,omitempty"` // Max number of vectors in a multivector
}
...
type CreateCollection struct {
	...
	Metadata               map[string]*Value     `protobuf:"bytes,18,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Arbitrary JSON metadata for the collection
}
...
type UpdateCollection struct {
	...
	StrictModeConfig    *StrictModeConfig       `protobuf:"bytes,9,opt,name=strict_mode_config,json=strictModeConfig,proto3,oneof" json:"strict_mode_config,omitempty"`                                          // New strict mode configuration
	Metadata            map[string]*Value       `protobuf:"bytes,10,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Arbitrary JSON-like metadata for the collection, will be merged with already stored metadata
}
...
type CollectionConfig struct {
	...
	Metadata           map[string]*Value     `protobuf:"bytes,7,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // Arbitrary JSON metadata for the collection
}
...
type IntegerIndexParams struct {
	...
	Lookup      *bool `protobuf:"varint,1,opt,name=lookup,proto3,oneof" json:"lookup,omitempty"`                              // If true - support direct lookups. Default is true.
	Range       *bool `protobuf:"varint,2,opt,name=range,proto3,oneof" json:"range,omitempty"`                                // If true - support ranges filters. Default is true.
	IsPrincipal *bool `protobuf:"varint,3,opt,name=is_principal,json=isPrincipal,proto3,oneof" json:"is_principal,omitempty"` // If true - use this key to organize storage of the collection data. This option assumes that this key will be used in majority of filtered requests. Default is false.
	OnDisk      *bool `protobuf:"varint,4,opt,name=on_disk,json=onDisk,proto3,oneof" json:"on_disk,omitempty"`                // If true - store index on disk. Default is false.
}
...
type StopwordsSet struct {
	...
	Languages []string `protobuf:"bytes,1,rep,name=languages,proto3" json:"languages,omitempty"` // List of languages to use stopwords from
	Custom    []string `protobuf:"bytes,2,rep,name=custom,proto3" json:"custom,omitempty"`       // List of custom stopwords
}
...
type TextIndexParams struct {
	...
	Stopwords      *StopwordsSet      `protobuf:"bytes,6,opt,name=stopwords,proto3,oneof" json:"stopwords,omitempty"`                                  // Stopwords for the text index
	PhraseMatching *bool              `protobuf:"varint,7,opt,name=phrase_matching,json=phraseMatching,proto3,oneof" json:"phrase_matching,omitempty"` // If true - support phrase matching.
	Stemmer        *StemmingAlgorithm `protobuf:"bytes,8,opt,name=stemmer,proto3,oneof" json:"stemmer,omitempty"`                                      // Set an algorithm for stemming.
	AsciiFolding   *bool              `protobuf:"varint,9,opt,name=ascii_folding,json=asciiFolding,proto3,oneof" json:"ascii_folding,omitempty"`       // If true, normalize tokens by folding accented characters to ASCII (e.g., "ação" -> "acao"). Default: false.
}
...
type StemmingAlgorithm_Snowball struct {
	Snowball *SnowballParams `protobuf:"bytes,1,opt,name=snowball,proto3,oneof"` // Parameters for snowball stemming
}
...
type SnowballParams struct {
	...
	Language string `protobuf:"bytes,1,opt,name=language,proto3" json:"language,omitempty"` // Which language the algorithm should stem.
}
...
type CollectionInfo struct {
	...
	Warnings            []*CollectionWarning          `protobuf:"bytes,11,rep,name=warnings,proto3" json:"warnings,omitempty"`                                                                                                                       // Warnings related to the collection
}
...
type CollectionClusterInfoResponse struct {
	...
	ReshardingOperations []*ReshardingInfo    `protobuf:"bytes,6,rep,name=resharding_operations,json=reshardingOperations,proto3" json:"resharding_operations,omitempty"` // Resharding operations
}
...
type ReplicatePoints struct {
	...
	FromShardKey *ShardKey `protobuf:"bytes,1,opt,name=from_shard_key,json=fromShardKey,proto3" json:"from_shard_key,omitempty"` // Source shard key
	ToShardKey   *ShardKey `protobuf:"bytes,2,opt,name=to_shard_key,json=toShardKey,proto3" json:"to_shard_key,omitempty"`       // Target shard key
	Filter       *Filter   `protobuf:"bytes,3,opt,name=filter,proto3,oneof" json:"filter,omitempty"`                             // If set - only points matching the filter will be replicated
}
...
type CreateShardKey struct {
	...
	InitialState      *ReplicaState `protobuf:"varint,5,opt,name=initial_state,json=initialState,proto3,enum=qdrant.ReplicaState,oneof" json:"initial_state,omitempty"` // Initial state of created replicas. Warning: use with care.
}
...
var file_collections_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd8, 0x03, 0x0a, 0x0c, 0x56, 0x65, 0x63, 0x74, 0x6f, 0x72,
	...
	,
	...
	,
	...
	0x74, 0x6f, 0x72, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65,
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x52, 0x0a, 0x11, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x56, 0x65, 0x63,
	0x74, 0x6f, 0x72, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x3d, 0x0a, 0x0a, 0x63, 0x6f, 0x6d,
	0x70, 0x61, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e,
	0x71, 0x64, 0x72, 0x61, 0x6e, 0x74, 0x2e, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x56, 0x65, 0x63, 0x74,
	0x6f, 0x72, 0x43, 0x6f, 0x6d, 0x70, 0x61, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x0a, 0x63, 0x6f,
	0x6d, 0x70, 0x61, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x43, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x43,
	...
	0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x42, 0x0a,
	0x17, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x78, 0x69, 0x73, 0x74,
	...
	,
	...
	,
	...
	0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x71, 0x64, 0x72, 0x61, 0x6e, 0x74,
	...
	,
	...
	0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x2d, 0x0a, 0x11, 0x43, 0x6f, 0x6c, 0x6c, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x57, 0x61, 0x72, 0x6e, 0x69, 0x6e, 0x67, 0x12, 0x18, 0x0a, 0x07,
	0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0x98, 0x03, 0x0a, 0x0e, 0x48, 0x6e, 0x73, 0x77, 0x43,
	...
	,
	...
	0x65, 0x64, 0x22, 0xa5, 0x06, 0x0a, 0x14, 0x4f, 0x70, 0x74, 0x69, 0x6d, 0x69, 0x7a, 0x65, 0x72,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x61, 0x64, 0x61, 0x74, 0x61, 0x1a, 0x4a, 0x0a, 0x0d, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74,
	...
	,
	...
	0x6d, 0x6f, 0x64, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x4a, 0x04, 0x08, 0x02, 0x10,
	0x03, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x0d, 0x10, 0x0e, 0x22, 0x8b, 0x07,
	...
	,
	...
	,
	...
	,
	...
	0x5f, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0d, 0x48, 0x01, 0x52,
	...
	,
	...
	,
	...
	0x73, 0x74, 0x65, 0x6e, 0x63, 0x79, 0x5f, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x42, 0x12, 0x0a,
	0x10, 0x5f, 0x6f, 0x6e, 0x5f, 0x64, 0x69, 0x73, 0x6b, 0x5f, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61,
	0x64, 0x42, 0x16, 0x0a, 0x14, 0x5f, 0x72, 0x65, 0x61, 0x64, 0x5f, 0x66, 0x61, 0x6e, 0x5f, 0x6f,
	0x75, 0x74, 0x5f, 0x66, 0x61, 0x63, 0x74, 0x6f, 0x72, 0x22, 0xda, 0x04, 0x0a, 0x10, 0x43, 0x6f,
	0x6c, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x30,
	...
	,
	...
	0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x42, 0x16, 0x0a, 0x14, 0x5f, 0x71, 0x75, 0x61, 0x6e,
	0x74, 0x69, 0x7a, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42,
	0x15, 0x0a, 0x13, 0x5f, 0x73, 0x74, 0x72, 0x69, 0x63, 0x74, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x5f,
	0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x22, 0x6e, 0x0a, 0x12, 0x4b, 0x65, 0x79, 0x77, 0x6f, 0x72,
	...
	0x73, 0x12, 0x1c, 0x0a, 0x07, 0x6f, 0x6e, 0x5f, 0x64, 0x69, 0x73, 0x6b, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x08, 0x48, 0x00, 0x52, 0x06, 0x6f, 0x6e, 0x44, 0x69, 0x73, 0x6b, 0x88, 0x01, 0x01, 0x12,
	0x26, 0x0a, 0x0c, 0x69, 0x73, 0x5f, 0x70, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x61, 0x6c, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x08, 0x48, 0x01, 0x52, 0x0b, 0x69, 0x73, 0x50, 0x72, 0x69, 0x6e, 0x63,
	0x69, 0x70, 0x61, 0x6c, 0x88, 0x01, 0x01, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x6f, 0x6e, 0x5f, 0x64,
	0x69, 0x73, 0x6b, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x69, 0x73, 0x5f, 0x70, 0x72, 0x69, 0x6e, 0x63,
	0x69, 0x70, 0x61, 0x6c, 0x22, 0x3a, 0x0a, 0x0e, 0x47, 0x65, 0x6f, 0x49, 0x6e, 0x64, 0x65, 0x78,
	...
	0x22, 0x44, 0x0a, 0x0c, 0x53, 0x74, 0x6f, 0x70, 0x77, 0x6f, 0x72, 0x64, 0x73, 0x53, 0x65, 0x74,
	...
	,
	...
	,
	...
	0x64, 0x69, 0x73, 0x6b, 0x22, 0x78, 0x0a, 0x13, 0x44, 0x61, 0x74, 0x65, 0x74, 0x69, 0x6d, 0x65,
	...
	0x6f, 0x6e, 0x44, 0x69, 0x73, 0x6b, 0x88, 0x01, 0x01, 0x12, 0x26, 0x0a, 0x0c, 0x69, 0x73, 0x5f,
	0x70, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x61, 0x6c, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x48,
	0x01, 0x52, 0x0b, 0x69, 0x73, 0x50, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x61, 0x6c, 0x88, 0x01,
	0x01, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x6f, 0x6e, 0x5f, 0x64, 0x69, 0x73, 0x6b, 0x42, 0x0f, 0x0a,
	0x0d, 0x5f, 0x69, 0x73, 0x5f, 0x70, 0x72, 0x69, 0x6e, 0x63, 0x69, 0x70, 0x61, 0x6c, 0x22, 0x6b,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x0a, 0x04, 0x73, 0x79, 0x6e, 0x63, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x04, 0x73, 0x79,
	0x6e, 0x63, 0x42, 0x0e, 0x0a, 0x0c, 0x5f, 0x74, 0x6f, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x64, 0x5f,
	0x69, 0x64, 0x22, 0xc1, 0x01, 0x0a, 0x0e, 0x52, 0x65, 0x73, 0x68, 0x61, 0x72, 0x64, 0x69, 0x6e,
	0x67, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x68, 0x61, 0x72, 0x64, 0x5f, 0x69,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
}
...
var file_collections_proto_enumTypes = make([]protoimpl.EnumInfo, 16)
var file_collections_proto_msgTypes = make([]protoimpl.MessageInfo, 96)
var file_collections_proto_goTypes = []any{
	...
	(BinaryQuantizationEncoding)(0),              // 8: qdrant.BinaryQuantizationEncoding
	(ShardingMethod)(0),                          // 9: qdrant.ShardingMethod
	(TokenizerType)(0),                           // 10: qdrant.TokenizerType
	(ReplicaState)(0),                            // 11: qdrant.ReplicaState
	(ReshardingDirection)(0),                     // 12: qdrant.ReshardingDirection
	(ShardTransferMethod)(0),                     // 13: qdrant.ShardTransferMethod
	(MaxOptimizationThreads_Setting)(0),          // 14: qdrant.MaxOptimizationThreads.Setting
	(BinaryQuantizationQueryEncoding_Setting)(0), // 15: qdrant.BinaryQuantizationQueryEncoding.Setting
	(*VectorParams)(nil),                         // 16: qdrant.VectorParams
	(*VectorParamsDiff)(nil),                     // 17: qdrant.VectorParamsDiff
	(*VectorParamsMap)(nil),                      // 18: qdrant.VectorParamsMap
	(*VectorParamsDiffMap)(nil),                  // 19: qdrant.VectorParamsDiffMap
	(*VectorsConfig)(nil),                        // 20: qdrant.VectorsConfig
	(*VectorsConfigDiff)(nil),                    // 21: qdrant.VectorsConfigDiff
	(*SparseVectorParams)(nil),                   // 22: qdrant.SparseVectorParams
	(*SparseVectorConfig)(nil),                   // 23: qdrant.SparseVectorConfig
	(*MultiVectorConfig)(nil),                    // 24: qdrant.MultiVectorConfig
	(*GetCollectionInfoRequest)(nil),             // 25: qdrant.GetCollectionInfoRequest
	(*CollectionExistsRequest)(nil),              // 26: qdrant.CollectionExistsRequest
	(*CollectionExists)(nil),                     // 27: qdrant.CollectionExists
	(*CollectionExistsResponse)(nil),             // 28: qdrant.CollectionExistsResponse
	(*ListCollectionsRequest)(nil),               // 29: qdrant.ListCollectionsRequest
	(*CollectionDescription)(nil),                // 30: qdrant.CollectionDescription
	(*GetCollectionInfoResponse)(nil),            // 31: qdrant.GetCollectionInfoResponse
	(*ListCollectionsResponse)(nil),              // 32: qdrant.ListCollectionsResponse
	(*MaxOptimizationThreads)(nil),               // 33: qdrant.MaxOptimizationThreads
	(*OptimizerStatus)(nil),                      // 34: qdrant.OptimizerStatus
	(*CollectionWarning)(nil),                    // 35: qdrant.CollectionWarning
	(*HnswConfigDiff)(nil),                       // 36: qdrant.HnswConfigDiff
	(*SparseIndexConfig)(nil),                    // 37: qdrant.SparseIndexConfig
	(*WalConfigDiff)(nil),                        // 38: qdrant.WalConfigDiff
	(*OptimizersConfigDiff)(nil),                 // 39: qdrant.OptimizersConfigDiff
	(*ScalarQuantization)(nil),                   // 40: qdrant.ScalarQuantization
	(*ProductQuantization)(nil),                  // 41: qdrant.ProductQuantization
	(*BinaryQuantizationQueryEncoding)(nil),      // 42: qdrant.BinaryQuantizationQueryEncoding
	(*BinaryQuantization)(nil),                   // 43: qdrant.BinaryQuantization
	(*QuantizationConfig)(nil),                   // 44: qdrant.QuantizationConfig
	(*Disabled)(nil),                             // 45: qdrant.Disabled
	(*QuantizationConfigDiff)(nil),               // 46: qdrant.QuantizationConfigDiff
	(*StrictModeConfig)(nil),                     // 47: qdrant.StrictModeConfig
	(*StrictModeSparseConfig)(nil),               // 48: qdrant.StrictModeSparseConfig
	(*StrictModeSparse)(nil),                     // 49: qdrant.StrictModeSparse
	(*StrictModeMultivectorConfig)(nil),          // 50: qdrant.StrictModeMultivectorConfig
	(*StrictModeMultivector)(nil),                // 51: qdrant.StrictModeMultivector
	(*CreateCollection)(nil),                     // 52: qdrant.CreateCollection
	(*UpdateCollection)(nil),                     // 53: qdrant.UpdateCollection
	(*DeleteCollection)(nil),                     // 54: qdrant.DeleteCollection
	(*CollectionOperationResponse)(nil),          // 55: qdrant.CollectionOperationResponse
	(*CollectionParams)(nil),                     // 56: qdrant.CollectionParams
	(*CollectionParamsDiff)(nil),                 // 57: qdrant.CollectionParamsDiff
	(*CollectionConfig)(nil),                     // 58: qdrant.CollectionConfig
	(*KeywordIndexParams)(nil),                   // 59: qdrant.KeywordIndexParams
	(*IntegerIndexParams)(nil),                   // 60: qdrant.IntegerIndexParams
	(*FloatIndexParams)(nil),                     // 61: qdrant.FloatIndexParams
	(*GeoIndexParams)(nil),                       // 62: qdrant.GeoIndexParams
	(*StopwordsSet)(nil),                         // 63: qdrant.StopwordsSet
	(*TextIndexParams)(nil),                      // 64: qdrant.TextIndexParams
	(*StemmingAlgorithm)(nil),                    // 65: qdrant.StemmingAlgorithm
	(*SnowballParams)(nil),                       // 66: qdrant.SnowballParams
	(*BoolIndexParams)(nil),                      // 67: qdrant.BoolIndexParams
	(*DatetimeIndexParams)(nil),                  // 68: qdrant.DatetimeIndexParams
	(*UuidIndexParams)(nil),                      // 69: qdrant.UuidIndexParams
	(*PayloadIndexParams)(nil),                   // 70: qdrant.PayloadIndexParams
	(*PayloadSchemaInfo)(nil),                    // 71: qdrant.PayloadSchemaInfo
	(*CollectionInfo)(nil),                       // 72: qdrant.CollectionInfo
	(*ChangeAliases)(nil),                        // 73: qdrant.ChangeAliases
	(*AliasOperations)(nil),                      // 74: qdrant.AliasOperations
	(*CreateAlias)(nil),                          // 75: qdrant.CreateAlias
	(*RenameAlias)(nil),                          // 76: qdrant.RenameAlias
	(*DeleteAlias)(nil),                          // 77: qdrant.DeleteAlias
	(*ListAliasesRequest)(nil),                   // 78: qdrant.ListAliasesRequest
	(*ListCollectionAliasesRequest)(nil),         // 79: qdrant.ListCollectionAliasesRequest
	(*AliasDescription)(nil),                     // 80: qdrant.AliasDescription
	(*ListAliasesResponse)(nil),                  // 81: qdrant.ListAliasesResponse
	(*CollectionClusterInfoRequest)(nil),         // 82: qdrant.CollectionClusterInfoRequest
	(*ShardKey)(nil),                             // 83: qdrant.ShardKey
	(*LocalShardInfo)(nil),                       // 84: qdrant.LocalShardInfo
	(*RemoteShardInfo)(nil),                      // 85: qdrant.RemoteShardInfo
	(*ShardTransferInfo)(nil),                    // 86: qdrant.ShardTransferInfo
	(*ReshardingInfo)(nil),                       // 87: qdrant.ReshardingInfo
	(*CollectionClusterInfoResponse)(nil),        // 88: qdrant.CollectionClusterInfoResponse
	(*MoveShard)(nil),                            // 89: qdrant.MoveShard
	(*ReplicateShard)(nil),                       // 90: qdrant.ReplicateShard
	(*AbortShardTransfer)(nil),                   // 91: qdrant.AbortShardTransfer
	(*RestartTransfer)(nil),                      // 92: qdrant.RestartTransfer
	(*ReplicatePoints)(nil),                      // 93: qdrant.ReplicatePoints
	(*Replica)(nil),                              // 94: qdrant.Replica
	(*CreateShardKey)(nil),                       // 95: qdrant.CreateShardKey
	(*DeleteShardKey)(nil),                       // 96: qdrant.DeleteShardKey
	(*UpdateCollectionClusterSetupRequest)(nil),  // 97: qdrant.UpdateCollectionClusterSetupRequest
	(*UpdateCollectionClusterSetupResponse)(nil), // 98: qdrant.UpdateCollectionClusterSetupResponse
	(*CreateShardKeyRequest)(nil),                // 99: qdrant.CreateShardKeyRequest
	(*DeleteShardKeyRequest)(nil),                // 100: qdrant.DeleteShardKeyRequest
	(*CreateShardKeyResponse)(nil),               // 101: qdrant.CreateShardKeyResponse
	(*DeleteShardKeyResponse)(nil),               // 102: qdrant.DeleteShardKeyResponse
	nil,                                          // 103: qdrant.VectorParamsMap.MapEntry
	nil,                                          // 104: qdrant.VectorParamsDiffMap.MapEntry
	nil,                                          // 105: qdrant.SparseVectorConfig.MapEntry
	nil,                                          // 106: qdrant.StrictModeSparseConfig.SparseConfigEntry
	nil,                                          // 107: qdrant.StrictModeMultivectorConfig.MultivectorConfigEntry
	nil,                                          // 108: qdrant.CreateCollection.MetadataEntry
	nil,                                          // 109: qdrant.UpdateCollection.MetadataEntry
	nil,                                          // 110: qdrant.CollectionConfig.MetadataEntry
	nil,                                          // 111: qdrant.CollectionInfo.PayloadSchemaEntry
	(*Filter)(nil),                               // 112: qdrant.Filter
	(*Value)(nil),                                // 113: qdrant.Value
}
var file_collections_proto_depIdxs = []int32{
	3,   // 0: qdrant.VectorParams.distance:type_name -> qdrant.Distance
	36,  // 1: qdrant.VectorParams.hnsw_config:type_name -> qdrant.HnswConfigDiff
	44,  // 2: qdrant.VectorParams.quantization_config:type_name -> qdrant.QuantizationConfig
	0,   // 3: qdrant.VectorParams.datatype:type_name -> qdrant.Datatype
	24,  // 4: qdrant.VectorParams.multivector_config:type_name -> qdrant.MultiVectorConfig
	36,  // 5: qdrant.VectorParamsDiff.hnsw_config:type_name -> qdrant.HnswConfigDiff
	46,  // 6: qdrant.VectorParamsDiff.quantization_config:type_name -> qdrant.QuantizationConfigDiff
	103, // 7: qdrant.VectorParamsMap.map:type_name -> qdrant.VectorParamsMap.MapEntry
	104, // 8: qdrant.VectorParamsDiffMap.map:type_name -> qdrant.VectorParamsDiffMap.MapEntry
	16,  // 9: qdrant.VectorsConfig.params:type_name -> qdrant.VectorParams
	18,  // 10: qdrant.VectorsConfig.params_map:type_name -> qdrant.VectorParamsMap
	17,  // 11: qdrant.VectorsConfigDiff.params:type_name -> qdrant.VectorParamsDiff
	19,  // 12: qdrant.VectorsConfigDiff.params_map:type_name -> qdrant.VectorParamsDiffMap
	37,  // 13: qdrant.SparseVectorParams.index:type_name -> qdrant.SparseIndexConfig
	1,   // 14: qdrant.SparseVectorParams.modifier:type_name -> qdrant.Modifier
	105, // 15: qdrant.SparseVectorConfig.map:type_name -> qdrant.SparseVectorConfig.MapEntry
	2,   // 16: qdrant.MultiVectorConfig.comparator:type_name -> qdrant.MultiVectorComparator
	27,  // 17: qdrant.CollectionExistsResponse.result:type_name -> qdrant.CollectionExists
	72,  // 18: qdrant.GetCollectionInfoResponse.result:type_name -> qdrant.CollectionInfo
	30,  // 19: qdrant.ListCollectionsResponse.collections:type_name -> qdrant.CollectionDescription
	14,  // 20: qdrant.MaxOptimizationThreads.setting:type_name -> qdrant.MaxOptimizationThreads.Setting
	0,   // 21: qdrant.SparseIndexConfig.datatype:type_name -> qdrant.Datatype
	33,  // 22: qdrant.OptimizersConfigDiff.max_optimization_threads:type_name -> qdrant.MaxOptimizationThreads
	6,   // 23: qdrant.ScalarQuantization.type:type_name -> qdrant.QuantizationType
	7,   // 24: qdrant.ProductQuantization.compression:type_name -> qdrant.CompressionRatio
	15,  // 25: qdrant.BinaryQuantizationQueryEncoding.setting:type_name -> qdrant.BinaryQuantizationQueryEncoding.Setting
	8,   // 26: qdrant.BinaryQuantization.encoding:type_name -> qdrant.BinaryQuantizationEncoding
	42,  // 27: qdrant.BinaryQuantization.query_encoding:type_name -> qdrant.BinaryQuantizationQueryEncoding
	40,  // 28: qdrant.QuantizationConfig.scalar:type_name -> qdrant.ScalarQuantization
	41,  // 29: qdrant.QuantizationConfig.product:type_name -> qdrant.ProductQuantization
	43,  // 30: qdrant.QuantizationConfig.binary:type_name -> qdrant.BinaryQuantization
	40,  // 31: qdrant.QuantizationConfigDiff.scalar:type_name -> qdrant.ScalarQuantization
	41,  // 32: qdrant.QuantizationConfigDiff.product:type_name -> qdrant.ProductQuantization
	45,  // 33: qdrant.QuantizationConfigDiff.disabled:type_name -> qdrant.Disabled
	43,  // 34: qdrant.QuantizationConfigDiff.binary:type_name -> qdrant.BinaryQuantization
	50,  // 35: qdrant.StrictModeConfig.multivector_config:type_name -> qdrant.StrictModeMultivectorConfig
	48,  // 36: qdrant.StrictModeConfig.sparse_config:type_name -> qdrant.StrictModeSparseConfig
	106, // 37: qdrant.StrictModeSparseConfig.sparse_config:type_name -> qdrant.StrictModeSparseConfig.SparseConfigEntry
	107, // 38: qdrant.StrictModeMultivectorConfig.multivector_config:type_name -> qdrant.StrictModeMultivectorConfig.MultivectorConfigEntry
	36,  // 39: qdrant.CreateCollection.hnsw_config:type_name -> qdrant.HnswConfigDiff
	38,  // 40: qdrant.CreateCollection.wal_config:type_name -> qdrant.WalConfigDiff
	39,  // 41: qdrant.CreateCollection.optimizers_config:type_name -> qdrant.OptimizersConfigDiff
	20,  // 42: qdrant.CreateCollection.vectors_config:type_name -> qdrant.VectorsConfig
	44,  // 43: qdrant.CreateCollection.quantization_config:type_name -> qdrant.QuantizationConfig
	9,   // 44: qdrant.CreateCollection.sharding_method:type_name -> qdrant.ShardingMethod
	23,  // 45: qdrant.CreateCollection.sparse_vectors_config:type_name -> qdrant.SparseVectorConfig
	47,  // 46: qdrant.CreateCollection.strict_mode_config:type_name -> qdrant.StrictModeConfig
	108, // 47: qdrant.CreateCollection.metadata:type_name -> qdrant.CreateCollection.MetadataEntry
	39,  // 48: qdrant.UpdateCollection.optimizers_config:type_name -> qdrant.OptimizersConfigDiff
	57,  // 49: qdrant.UpdateCollection.params:type_name -> qdrant.CollectionParamsDiff
	36,  // 50: qdrant.UpdateCollection.hnsw_config:type_name -> qdrant.HnswConfigDiff
	21,  // 51: qdrant.UpdateCollection.vectors_config:type_name -> qdrant.VectorsConfigDiff
	46,  // 52: qdrant.UpdateCollection.quantization_config:type_name -> qdrant.QuantizationConfigDiff
	23,  // 53: qdrant.UpdateCollection.sparse_vectors_config:type_name -> qdrant.SparseVectorConfig
	47,  // 54: qdrant.UpdateCollection.strict_mode_config:type_name -> qdrant.StrictModeConfig
	109, // 55: qdrant.UpdateCollection.metadata:type_name -> qdrant.UpdateCollection.MetadataEntry
	20,  // 56: qdrant.CollectionParams.vectors_config:type_name -> qdrant.VectorsConfig
	9,   // 57: qdrant.CollectionParams.sharding_method:type_name -> qdrant.ShardingMethod
	23,  // 58: qdrant.CollectionParams.sparse_vectors_config:type_name -> qdrant.SparseVectorConfig
	56,  // 59: qdrant.CollectionConfig.params:type_name -> qdrant.CollectionParams
	36,  // 60: qdrant.CollectionConfig.hnsw_config:type_name -> qdrant.HnswConfigDiff
	39,  // 61: qdrant.CollectionConfig.optimizer_config:type_name -> qdrant.OptimizersConfigDiff
	38,  // 62: qdrant.CollectionConfig.wal_config:type_name -> qdrant.WalConfigDiff
	44,  // 63: qdrant.CollectionConfig.quantization_config:type_name -> qdrant.QuantizationConfig
	47,  // 64: qdrant.CollectionConfig.strict_mode_config:type_name -> qdrant.StrictModeConfig
	110, // 65: qdrant.CollectionConfig.metadata:type_name -> qdrant.CollectionConfig.MetadataEntry
	10,  // 66: qdrant.TextIndexParams.tokenizer:type_name -> qdrant.TokenizerType
	63,  // 67: qdrant.TextIndexParams.stopwords:type_name -> qdrant.StopwordsSet
	65,  // 68: qdrant.TextIndexParams.stemmer:type_name -> qdrant.StemmingAlgorithm
	66,  // 69: qdrant.StemmingAlgorithm.snowball:type_name -> qdrant.SnowballParams
	59,  // 70: qdrant.PayloadIndexParams.keyword_index_params:type_name -> qdrant.KeywordIndexParams
	60,  // 71: qdrant.PayloadIndexParams.integer_index_params:type_name -> qdrant.IntegerIndexParams
	61,  // 72: qdrant.PayloadIndexParams.float_index_params:type_name -> qdrant.FloatIndexParams
	62,  // 73: qdrant.PayloadIndexParams.geo_index_params:type_name -> qdrant.GeoIndexParams
	64,  // 74: qdrant.PayloadIndexParams.text_index_params:type_name -> qdrant.TextIndexParams
	67,  // 75: qdrant.PayloadIndexParams.bool_index_params:type_name -> qdrant.BoolIndexParams
	68,  // 76: qdrant.PayloadIndexParams.datetime_index_params:type_name -> qdrant.DatetimeIndexParams
	69,  // 77: qdrant.PayloadIndexParams.uuid_index_params:type_name -> qdrant.UuidIndexParams
	5,   // 78: qdrant.PayloadSchemaInfo.data_type:type_name -> qdrant.PayloadSchemaType
	70,  // 79: qdrant.PayloadSchemaInfo.params:type_name -> qdrant.PayloadIndexParams
	4,   // 80: qdrant.CollectionInfo.status:type_name -> qdrant.CollectionStatus
	34,  // 81: qdrant.CollectionInfo.optimizer_status:type_name -> qdrant.OptimizerStatus
	58,  // 82: qdrant.CollectionInfo.config:type_name -> qdrant.CollectionConfig
	111, // 83: qdrant.CollectionInfo.payload_schema:type_name -> qdrant.CollectionInfo.PayloadSchemaEntry
	35,  // 84: qdrant.CollectionInfo.warnings:type_name -> qdrant.CollectionWarning
	74,  // 85: qdrant.ChangeAliases.actions:type_name -> qdrant.AliasOperations
	75,  // 86: qdrant.AliasOperations.create_alias:type_name -> qdrant.CreateAlias
	76,  // 87: qdrant.AliasOperations.rename_alias:type_name -> qdrant.RenameAlias
	77,  // 88: qdrant.AliasOperations.delete_alias:type_name -> qdrant.DeleteAlias
	80,  // 89: qdrant.ListAliasesResponse.aliases:type_name -> qdrant.AliasDescription
	11,  // 90: qdrant.LocalShardInfo.state:type_name -> qdrant.ReplicaState
	83,  // 91: qdrant.LocalShardInfo.shard_key:type_name -> qdrant.ShardKey
	11,  // 92: qdrant.RemoteShardInfo.state:type_name -> qdrant.ReplicaState
	83,  // 93: qdrant.RemoteShardInfo.shard_key:type_name -> qdrant.ShardKey
	83,  // 94: qdrant.ReshardingInfo.shard_key:type_name -> qdrant.ShardKey
	12,  // 95: qdrant.ReshardingInfo.direction:type_name -> qdrant.ReshardingDirection
	84,  // 96: qdrant.CollectionClusterInfoResponse.local_shards:type_name -> qdrant.LocalShardInfo
	85,  // 97: qdrant.CollectionClusterInfoResponse.remote_shards:type_name -> qdrant.RemoteShardInfo
	86,  // 98: qdrant.CollectionClusterInfoResponse.shard_transfers:type_name -> qdrant.ShardTransferInfo
	87,  // 99: qdrant.CollectionClusterInfoResponse.resharding_operations:type_name -> qdrant.ReshardingInfo
	13,  // 100: qdrant.MoveShard.method:type_name -> qdrant.ShardTransferMethod
	13,  // 101: qdrant.ReplicateShard.method:type_name -> qdrant.ShardTransferMethod
	13,  // 102: qdrant.RestartTransfer.method:type_name -> qdrant.ShardTransferMethod
	83,  // 103: qdrant.ReplicatePoints.from_shard_key:type_name -> qdrant.ShardKey
	83,  // 104: qdrant.ReplicatePoints.to_shard_key:type_name -> qdrant.ShardKey
	112, // 105: qdrant.ReplicatePoints.filter:type_name -> qdrant.Filter
	83,  // 106: qdrant.CreateShardKey.shard_key:type_name -> qdrant.ShardKey
	11,  // 107: qdrant.CreateShardKey.initial_state:type_name -> qdrant.ReplicaState
	83,  // 108: qdrant.DeleteShardKey.shard_key:type_name -> qdrant.ShardKey
	89,  // 109: qdrant.UpdateCollectionClusterSetupRequest.move_shard:type_name -> qdrant.MoveShard
	90,  // 110: qdrant.UpdateCollectionClusterSetupRequest.replicate_shard:type_name -> qdrant.ReplicateShard
	91,  // 111: qdrant.UpdateCollectionClusterSetupRequest.abort_transfer:type_name -> qdrant.AbortShardTransfer
	94,  // 112: qdrant.UpdateCollectionClusterSetupRequest.drop_replica:type_name -> qdrant.Replica
	95,  // 113: qdrant.UpdateCollectionClusterSetupRequest.create_shard_key:type_name -> qdrant.CreateShardKey
	96,  // 114: qdrant.UpdateCollectionClusterSetupRequest.delete_shard_key:type_name -> qdrant.DeleteShardKey
	92,  // 115: qdrant.UpdateCollectionClusterSetupRequest.restart_transfer:type_name -> qdrant.RestartTransfer
	93,  // 116: qdrant.UpdateCollectionClusterSetupRequest.replicate_points:type_name -> qdrant.ReplicatePoints
	95,  // 117: qdrant.CreateShardKeyRequest.request:type_name -> qdrant.CreateShardKey
	96,  // 118: qdrant.DeleteShardKeyRequest.request:type_name -> qdrant.DeleteShardKey
	16,  // 119: qdrant.VectorParamsMap.MapEntry.value:type_name -> qdrant.VectorParams
	17,  // 120: qdrant.VectorParamsDiffMap.MapEntry.value:type_name -> qdrant.VectorParamsDiff
	22,  // 121: qdrant.SparseVectorConfig.MapEntry.value:type_name -> qdrant.SparseVectorParams
	49,  // 122: qdrant.StrictModeSparseConfig.SparseConfigEntry.value:type_name -> qdrant.StrictModeSparse
	51,  // 123: qdrant.StrictModeMultivectorConfig.MultivectorConfigEntry.value:type_name -> qdrant.StrictModeMultivector
	113, // 124: qdrant.CreateCollection.MetadataEntry.value:type_name -> qdrant.Value
	113, // 125: qdrant.UpdateCollection.MetadataEntry.value:type_name -> qdrant.Value
	113, // 126: qdrant.CollectionConfig.MetadataEntry.value:type_name -> qdrant.Value
	71,  // 127: qdrant.CollectionInfo.PayloadSchemaEntry.value:type_name -> qdrant.PayloadSchemaInfo
...
func file_collections_proto_init() {
	...
	file_collections_proto_msgTypes[53].OneofWrappers = []any{}
	file_collections_proto_msgTypes[54].OneofWrappers = []any{
	...
	file_collections_proto_msgTypes[77].OneofWrappers = []any{}
	...
	file_collections_proto_msgTypes[83].OneofWrappers = []any{}
