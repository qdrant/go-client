...
var file_points_proto_rawDesc = []byte{
	...
	0x75, 0x73, 0x22, 0x83, 0x01, 0x0a, 0x0b, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x43, 0x6f, 0x75,
	...
	,
	...
	0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x65, 0x64, 0x10, 0x02, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_points_proto_msgTypes = make([]protoimpl.MessageInfo, 75)
var file_points_proto_goTypes = []interface{}{
	...
	(*ValuesCount)(nil),                // 69: qdrant.ValuesCount
	(*PointsSelector)(nil),             // 70: qdrant.PointsSelector
	(*PointsIdsList)(nil),              // 71: qdrant.PointsIdsList
	(*PointStruct)(nil),                // 72: qdrant.PointStruct
	(*GeoPoint)(nil),                   // 73: qdrant.GeoPoint
	nil,                                // 74: qdrant.SetPayloadPoints.PayloadEntry
	nil,                                // 75: qdrant.NamedVectors.VectorsEntry
	nil,                                // 76: qdrant.ScoredPoint.PayloadEntry
	nil,                                // 77: qdrant.RetrievedPoint.PayloadEntry
	nil,                                // 78: qdrant.PointStruct.PayloadEntry
	(*PayloadIndexParams)(nil),         // 79: qdrant.PayloadIndexParams
	(*Value)(nil),                      // 80: qdrant.Value
}
var file_points_proto_depIdxs = []int32{
	...
	72,  // 2: qdrant.UpsertPoints.points:type_name -> qdrant.PointStruct
	4,   // 3: qdrant.UpsertPoints.ordering:type_name -> qdrant.WriteOrdering
	70,  // 4: qdrant.DeletePoints.points:type_name -> qdrant.PointsSelector
	...
	70,  // 14: qdrant.DeletePointVectors.points_selector:type_name -> qdrant.PointsSelector
	...
	74,  // 17: qdrant.SetPayloadPoints.payload:type_name -> qdrant.SetPayloadPoints.PayloadEntry
	70,  // 18: qdrant.SetPayloadPoints.points_selector:type_name -> qdrant.PointsSelector
	4,   // 19: qdrant.SetPayloadPoints.ordering:type_name -> qdrant.WriteOrdering
	70,  // 20: qdrant.DeletePayloadPoints.points_selector:type_name -> qdrant.PointsSelector
	4,   // 21: qdrant.DeletePayloadPoints.ordering:type_name -> qdrant.WriteOrdering
	70,  // 22: qdrant.ClearPayloadPoints.points:type_name -> qdrant.PointsSelector
	...
	79,  // 25: qdrant.CreateFieldIndexCollection.field_index_params:type_name -> qdrant.PayloadIndexParams
	...
	75,  // 30: qdrant.NamedVectors.vectors:type_name -> qdrant.NamedVectors.VectorsEntry
	...
	76,  // 78: qdrant.ScoredPoint.payload:type_name -> qdrant.ScoredPoint.PayloadEntry
	...
	77,  // 92: qdrant.RetrievedPoint.payload:type_name -> qdrant.RetrievedPoint.PayloadEntry
	...
	69,  // 113: qdrant.FieldCondition.values_count:type_name -> qdrant.ValuesCount
	...
	73,  // 118: qdrant.GeoBoundingBox.top_left:type_name -> qdrant.GeoPoint
	73,  // 119: qdrant.GeoBoundingBox.bottom_right:type_name -> qdrant.GeoPoint
	73,  // 120: qdrant.GeoRadius.center:type_name -> qdrant.GeoPoint
	71,  // 121: qdrant.PointsSelector.points:type_name -> qdrant.PointsIdsList
	56,  // 122: qdrant.PointsSelector.filter:type_name -> qdrant.Filter
	6,   // 123: qdrant.PointsIdsList.ids:type_name -> qdrant.PointId
	6,   // 124: qdrant.PointStruct.id:type_name -> qdrant.PointId
	78,  // 125: qdrant.PointStruct.payload:type_name -> qdrant.PointStruct.PayloadEntry
	23,  // 126: qdrant.PointStruct.vectors:type_name -> qdrant.Vectors
	80,  // 127: qdrant.SetPayloadPoints.PayloadEntry.value:type_name -> qdrant.Value
	7,   // 128: qdrant.NamedVectors.VectorsEntry.value:type_name -> qdrant.Vector
	80,  // 129: qdrant.ScoredPoint.PayloadEntry.value:type_name -> qdrant.Value
	80,  // 130: qdrant.RetrievedPoint.PayloadEntry.value:type_name -> qdrant.Value
	80,  // 131: qdrant.PointStruct.PayloadEntry.value:type_name -> qdrant.Value
